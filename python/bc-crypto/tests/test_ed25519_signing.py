"""Tests translated from Rust ed25519_signing.rs."""

from dataclasses import dataclass

from bc_rand import fake_random_data
...
RFC8032_VECTORS = [
    ...
    VectorCase(
        secret_key=bytes.fromhex("c5aa8df43f9f837bedb7442f31dcb7b166d38535076f094b85ce3a2e0b4458f7"),
        public_key=bytes.fromhex("fc51cd8e6218a1a38da47ed00230f0580816ed13ba3303ac5deb911548908025"),
        message=bytes.fromhex("af82"),
        signature=bytes.fromhex("6291d657deec24024827e69c3abe01a30ce548a284743a445e3680d7db5ac3ac18ff9b538d16f290ae67f760984dc6594a7c15e9716ed28dc027beceea1ec40a"),
    ),
    VectorCase(
        secret_key=bytes.fromhex("f5e5767cf153319517630f226876b86c8160cc583bc013744c6bf255f5cc0ee5"),
        ...
        signature=bytes.fromhex("0aab4c900501b3e24d7cdf4663326a3a87df5e4843b2cbdb67cbf6e460fec350aa5371b1508f9f4528ecea23c436d94b5e8fcd4f681e30a6ac00a9704a188a03"),
    ),
]


def test_ed25519_signing() -> None:
    message = (
        b"Ladies and Gentlemen of the class of '99: If I could offer you only "
        b"one tip for the future, sunscreen would be it."
    )

    private_key = fake_random_data(ED25519_PRIVATE_KEY_SIZE)
    ...
    assert signature == bytes.fromhex(
        "647cc65243e8a61dc273242b13008994e4658a7e0bcbb1fd621b01dad2ddf757"
        "7901c4c4d4ea484ae5ca3172c4b8a75877bd7d5349a7055acdc023b04fcd0406"
    )
...
def test_ed25519_vectors() -> None:
    for vector in RFC8032_VECTORS:
        assert ed25519_public_key_from_private_key(vector.secret_key) == vector.public_key
        assert ed25519_verify(vector.public_key, vector.message, vector.signature)
