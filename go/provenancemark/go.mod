module github.com/nickel-blockchaincommons/provenancemark-go

go 1.22.0

require (
	github.com/nickel-blockchaincommons/bcenvelope-go v0.0.0
...
require (
	...
	github.com/nickel-blockchaincommons/bccomponents-go v0.0.0 // indirect
	...
	github.com/nickel-blockchaincommons/knownvalues-go v0.0.0 // indirect
...
replace (
	...
	github.com/nickel-blockchaincommons/bcenvelope-go => ../bcenvelope
