...
// Bytewords contains the 256 four-letter bytewords.
var Bytewords = [256]string{
...
// Bytemojis contains the 256 emoji identifiers for bytemoji encoding.
var Bytemojis = [256]string{
	"😀", "😂", "😆", "😉", "🙄", "😋", "😎", "😍", "😘", "😭", "🫠", "🥱",
	"🤩", "😶", "🤨", "🫥", "🥵", "🥶", "😳", "🤪", "😵", "😡", "🤢", "😇",
	"🤠", "🤡", "🥳", "🥺", "😬", "🤑", "🙃", "🤯", "😈", "👹", "👺", "💀",
	"👻", "👽", "😺", "😹", "😻", "😽", "🙀", "😿", "🫶", "🤲", "🙌", "🤝",
...
// wordToIndex maps full bytewords to their byte value.
var wordToIndex map[string]byte

// minimalToIndex maps minimal (2-letter) codes to their byte value.
var minimalToIndex map[string]byte

func init() {
	wordToIndex = make(map[string]byte, 256)
	for i, w := range Bytewords {
		wordToIndex[w] = byte(i)
	}
	minimalToIndex = make(map[string]byte, 256)
	for i, m := range minimals {
