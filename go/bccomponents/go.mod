module github.com/nickel-blockchaincommons/bccomponents-go

go 1.22.0

require (
	github.com/cloudflare/circl v1.6.3
	github.com/nickel-blockchaincommons/bccrypto-go v0.0.0
	...
	github.com/nickel-blockchaincommons/sskr-go v0.0.0
