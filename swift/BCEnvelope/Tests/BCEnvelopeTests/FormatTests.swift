...
struct FormatTests {
    ...
    @Test func testComplexMetadata() throws {
        ...
        let work = try Envelope(try! ARID(‡"7fb90a9d96c07f39f75ea6acf392d79f241fac4ec0be2120f7c82489711e3e80"))
            .addType("novel")
    ...
    static let credential = {
        var rng = makeFakeRandomNumberGenerator()
        return try! Envelope(try! ARID(‡"4676635a6e6068c2ef3ffd8ff726dd401fd341036e920f136a1d8af5e829496d"))
