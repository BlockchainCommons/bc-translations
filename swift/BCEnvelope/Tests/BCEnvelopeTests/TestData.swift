...
let symmetricKey = try! SymmetricKey(‡"38900719dea655e9a1bc1682aaccf0bfcd79a7239db672d39216e4acdd660dc0")

let aliceIdentifier = try! ARID(‡"d44c5e0afd353f47b02f58a5a3a29d9a2efa6298692f896cd2923268599a0d0f")
...
let bobIdentifier = try! ARID(‡"24b5b23d8aed462c5a3c02cc4972315eb71a6c5fdfc0063de28603f467ae499c")
...
let carolIdentifier = try! ARID(‡"06c777262faedf49a443277474c1c08531efcff4c58e9cb3b04f7fc1c0e6d60d")
...
let exampleLedgerIdentifier = try! ARID(‡"0eda5ce79a2b5619e387f490861a2e7211559029b3b369cf98fb749bd3ba9a5d")
...
let stateIdentifier = try! ARID(‡"04363d5ff99733bc0f1577baba440af1cf344ad9e454fad9d128c00fef6505e8")
...
let fakeContentKey = try! SymmetricKey(‡"526afd95b2229c5381baec4a1788507a3c4a566ca5cce64543b46ad12aff0035")
let fakeNonce = try! Nonce(‡"4d785658f36c22fb5aed3ac0")
