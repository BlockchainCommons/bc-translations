...
- [x] `Seed` translated
- [x] `PrivateKeyBase` translated (non-SSH paths complete)
...
- [x] Signing key modules translated (`Signature`, `SigningPrivateKey`, `SigningPublicKey`, `SignatureScheme`, traits) except SSH variants
...
- [ ] All translatable behavior tests ported to Swift (`80/97` currently ported)
