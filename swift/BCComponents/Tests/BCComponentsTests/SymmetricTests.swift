...
final class SymmetricTests: XCTestCase {
    ...
    private let key = try! SymmetricKey.fromData(hexData("808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9f"))
    private let nonce = try! Nonce.fromData(hexData("070000004041424344454647"))
    ...
    private let expectedAuth = try! AuthenticationTag.fromData(hexData("1ae10b594f09e26a7e902ecbd0600691"))
